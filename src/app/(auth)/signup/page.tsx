  ...
  return (
    <main className="relative min-h-dvh overflow-hidden bg-[#101015] text-[#F1F0E1]">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(244,63,94,0.20),transparent_55%),radial-gradient(circle_at_78%_70%,rgba(241,240,225,0.06),transparent_60%)]" />
      </div>
      ...
      <div className="relative mx-auto flex min-h-dvh max-w-md flex-col justify-center px-6 py-16">
        ...
        <h1 className="mt-4 font-mono text-4xl tracking-tight">Sign up</h1>
        <p className="mt-3 text-sm text-[#F1F0E1]/65">Create your account.</p>
        ...
        >
          <div className="grid gap-2">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-white/10 bg-[#101015]/40 px-4 py-3 text-sm text-[#F1F0E1] outline-none focus:border-rose-400"
              required
            />
          </div>
          ...
          <button
            type="submit"
            className="gb-btn w-full rounded-2xl bg-[#F1F0E1] py-3 text-sm font-semibold text-[#101015]"
          >
            Create account
          </button>
        </form>
        ...
        <p className="mt-6 text-sm text-[#F1F0E1]/65">
          ...
          <Link href="/login" className="font-medium text-[#F1F0E1]">
            Log in
          </Link>
        </p>
      </div>
